...
// google first: it's the one free engine that reliably works from a static page;
// edge is kept in the picker, but its trial WebSocket can 403 from the browser.
export const ENGINE_ORDER = ["google", "edge", "elevenlabs", "openai"];
